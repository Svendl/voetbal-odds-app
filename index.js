// pages/index.js
// Voetbal Odds Analyzer Frontend - Mooie UI
...
export default function Home() {
  ...
  // Button 1: Wie voetbalt er vandaag?
      ...
      {!results && !loading && !error && (
        <div style={styles.infoBox}>
          ...
          <p style={styles.disclaimer}>
            ⚠️ <strong>Disclaimer:</strong> Dit zijn AI-gebaseerde analysees. 
            Verifieer altijd bij je bookmaker. Speel verantwoord — 18+.
          </p>
        </div>
      )}
    </div>
